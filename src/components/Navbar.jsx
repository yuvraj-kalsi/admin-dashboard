...
const Navbar = () => {
  ...
  // Second Parameter : Dependency, when it will be called
  ...
  return (
    ...
    // Menu icon to open/close the sidebar
    ...
    p-2 md:mx-6 relative'>
      ...
      {/* icon for cart, chat, notification, profile */}
      <div className='flex'>
        ...
        {/* Adding photo at top-left and name */}
        <TooltipComponent
        ...
        {/* If clicked open it otherwise not */}
        {isClicked.cart && <Cart />}
        {isClicked.chat && <Chat />}
